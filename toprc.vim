...
execute 'source ' s:path_to_this_script . '/plugin_config/ultisnips.vim'
execute 'source ' s:path_to_this_script . '/plugin_config/fzf.vim'
execute 'source ' s:path_to_this_script . '/plugin_config/vim_markdown.vim'
execute 'source ' s:path_to_this_script . '/plugin_config/vim_pandoc_syntax.vim'
execute 'source ' s:path_to_this_script . '/plugin_config/tagbar_config.vim'
